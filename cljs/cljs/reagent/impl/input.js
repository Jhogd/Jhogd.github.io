...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__5783){
var map__5784 = p__5783;
var map__5784__$1 = (((((!((map__5784 == null))))?(((((map__5784.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__5784.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__5784):map__5784);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5784__$1,cljs.core.cst$kw$on_DASH_write);
...
(jsprops.onChange = (function (p1__5786_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__5786_SHARP_);
}));
