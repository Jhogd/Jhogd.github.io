...
var temp__5820__auto__ = reagent.impl.template.cache_get(reagent.impl.template.prop_name_cache,cljs.core.name(k));
...
if(reagent.impl.util.named_QMARK_(k)){
var temp__5820__auto__ = reagent.impl.template.cache_get(reagent.impl.template.custom_prop_name_cache,cljs.core.name(k));
if((temp__5820__auto__ == null)){
var v = reagent.impl.util.dash_to_prop_name(k);
...
var temp__5822__auto___6100 = reagent.impl.util.react_key_from_vec(v);
if((temp__5822__auto___6100 == null)){
} else {
var key_6101 = temp__5822__auto___6100;
...
var temp__5822__auto___6104 = reagent.impl.util.react_key_from_vec(v);
if((temp__5822__auto___6104 == null)){
} else {
var key_6105 = temp__5822__auto___6104;
...
var temp__5822__auto___6106 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5822__auto___6106 == null)){
} else {
var key_6107 = temp__5822__auto___6106;
...
var temp__5820__auto__ = reagent.impl.template.cache_get(reagent.impl.template.tag_name_cache,x);
if((temp__5820__auto__ == null)){
...
var temp__5822__auto___6108 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5822__auto___6108 == null)){
} else {
var key_6109 = temp__5822__auto___6108;
...
var temp__5822__auto___6110 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5822__auto___6110 == null)){
} else {
var key_6111 = temp__5822__auto___6110;
...
*/
reagent.impl.template.t_reagent$impl$template6123 = (function (opts,id,fn_to_element,parse_fn,meta6124){
this.opts = opts;
this.id = id;
...
var self__ = this;
var _6125__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template6123(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta6124__$1));
}));
...
(reagent.impl.template.t_reagent$impl$template6123.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$opts,cljs.core.cst$sym$id,cljs.core.cst$sym$fn_DASH_to_DASH_element,cljs.core.cst$sym$parse_DASH_fn,cljs.core.cst$sym$meta6124], null);
}));
 ...
 */
reagent.impl.template.__GT_t_reagent$impl$template6123 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template6123(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta6124){
return (new reagent.impl.template.t_reagent$impl$template6123(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta6124));
});

}

return (new reagent.impl.template.t_reagent$impl$template6123(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
