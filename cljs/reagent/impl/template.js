...
var temp__5820__auto__ = reagent.impl.template.cache_get.call(null,reagent.impl.template.prop_name_cache,cljs.core.name.call(null,k));
...
var k_SINGLEQUOTE_ = temp__5820__auto__;
...
var G__5269 = o;
goog.object.set(G__5269,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__5271__i = 0, G__5271__a = new Array(arguments.length -  0);
while (G__5271__i < G__5271__a.length) {G__5271__a[G__5271__i] = arguments[G__5271__i + 0]; ++G__5271__i;}
  args = new cljs.core.IndexedSeq(G__5271__a,0,null);
} 
return G__5270__delegate.call(this,args);};
G__5270.cljs$lang$maxFixedArity = 0;
G__5270.cljs$lang$applyTo = (function (arglist__5272){
...
if(reagent.impl.util.named_QMARK_.call(null,k)){
var temp__5820__auto__ = reagent.impl.template.cache_get.call(null,reagent.impl.template.custom_prop_name_cache,cljs.core.name.call(null,k));
if((temp__5820__auto__ == null)){
var v = reagent.impl.util.dash_to_prop_name.call(null,k);
...
var G__5273 = o;
goog.object.set(G__5273,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var args = null;
if (arguments.length > 0) {
var G__5275__i = 0, G__5275__a = new Array(arguments.length -  0);
while (G__5275__i < G__5275__a.length) {G__5275__a[G__5275__i] = arguments[G__5275__i + 0]; ++G__5275__i;}
  args = new cljs.core.IndexedSeq(G__5275__a,0,null);
} 
return G__5274__delegate.call(this,args);};
G__5274.cljs$lang$maxFixedArity = 0;
G__5274.cljs$lang$applyTo = (function (arglist__5276){
...
var G__5277 = props;
var G__5277__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__5277,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__5277);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__5277__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__5278 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__5278,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__5278;
}
})(),id_class);
...
var G__5279 = (cljs.core.count.call(null,argv) - first_child);
switch (G__5279) {
case (0):
...
var vec__5281 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__5281,(0),null);
var id = cljs.core.nth.call(null,vec__5281,(1),null);
var className = cljs.core.nth.call(null,vec__5281,(2),null);
...
var temp__5822__auto___5284 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5822__auto___5284 == null)){
} else {
var key_5285 = temp__5822__auto___5284;
(jsprops.key = key_5285);
}
...
var temp__5822__auto___5286 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5822__auto___5286 == null)){
} else {
var key_5287 = temp__5822__auto___5286;
(jsprops.key = key_5287);
}
...
var temp__5822__auto___5288 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5822__auto___5288 == null)){
} else {
var key_5289 = temp__5822__auto___5288;
(jsprops.key = key_5289);
}
...
var temp__5820__auto__ = reagent.impl.template.cache_get.call(null,reagent.impl.template.tag_name_cache,x);
if((temp__5820__auto__ == null)){
...
var temp__5822__auto___5290 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5822__auto___5290 == null)){
} else {
var key_5291 = temp__5822__auto___5290;
(jsprops.key = key_5291);
}
...
var temp__5822__auto___5292 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5822__auto___5292 == null)){
} else {
var key_5293 = temp__5822__auto___5292;
(jsprops.key = key_5293);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__5294_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__5294_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__5295 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__5295,(0),null);
var derefed = cljs.core.nth.call(null,vec__5295,(1),null);
...
break;
default:
var G__5300 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__5301 = compiler;
v = G__5300;
compiler = G__5301;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template5305 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template5305 = (function (opts,id,fn_to_element,parse_fn,meta5306){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta5306 = meta5306;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template5305.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_5307,meta5306__$1){
var self__ = this;
var _5307__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template5305(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta5306__$1));
}));

(reagent.impl.template.t_reagent$impl$template5305.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_5307){
var self__ = this;
var _5307__$1 = this;
return self__.meta5306;
}));

(reagent.impl.template.t_reagent$impl$template5305.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template5305.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template5305.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template5305.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template5305.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template5305.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta5306","meta5306",606630663,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template5305.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template5305.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template5305");

(reagent.impl.template.t_reagent$impl$template5305.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write.call(null,writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template5305");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template5305.
 */
reagent.impl.template.__GT_t_reagent$impl$template5305 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template5305(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta5306){
return (new reagent.impl.template.t_reagent$impl$template5305(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta5306));
});

}

return (new reagent.impl.template.t_reagent$impl$template5305(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
