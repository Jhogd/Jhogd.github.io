...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__5220){
var map__5221 = p__5220;
var map__5221__$1 = (((((!((map__5221 == null))))?(((((map__5221.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__5221.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__5221):map__5221);
var on_write = cljs.core.get.call(null,map__5221__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
(jsprops.onChange = (function (p1__5223_SHARP_){
return reagent.impl.input.input_handle_change.call(null,this$,on_change,p1__5223_SHARP_);
}));
