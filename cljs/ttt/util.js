...
var len__4736__auto___4717 = arguments.length;
var i__4737__auto___4718 = (0);
while(true){
if((i__4737__auto___4718 < len__4736__auto___4717)){
args_arr__4757__auto__.push((arguments[i__4737__auto___4718]));

var G__4719 = (i__4737__auto___4718 + (1));
i__4737__auto___4718 = G__4719;
continue;
} else {
}
break;
...
/** @this {Function} */
(ttt.util.new_game.cljs$lang$applyTo = (function (seq4714){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq4714));
}));
...
return [clojure.string.join.call(null,"\n",cljs.core.map.call(null,(function (p1__4720_SHARP_){
return cljs.core.apply.call(null,cljs.core.str,cljs.core.replace.call(null,new cljs.core.PersistentArrayMap(null, 1, [null,"-"], null),p1__4720_SHARP_));
}),cljs.core.partition.call(null,ttt.util.length.call(null,board),board))),"\n"].join('');
});
ttt.util.as_board = (function ttt$util$as_board(string){
return cljs.core.vec.call(null,cljs.core.map.call(null,(function (p1__4723_SHARP_){
if(cljs.core._EQ_.call(null,"-",p1__4723_SHARP_)){
return null;
} else {
return p1__4723_SHARP_;
}
}),cljs.core.reduce.call(null,cljs.core.concat,cljs.core.filter.call(null,(function (p1__4722_SHARP_){
return ((1) < cljs.core.count.call(null,p1__4722_SHARP_));
}),cljs.core.partition_by.call(null,(function (p1__4721_SHARP_){
