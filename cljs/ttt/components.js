...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"fieldset","fieldset",-1949770816),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),id], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label","label",1718410804),id], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"br","br",934104792)], null),cljs.core.apply.call(null,cljs.core.concat,(function (){var iter__4529__auto__ = (function ttt$components$radio_menu_$_iter__4936(s__4937){
return (new cljs.core.LazySeq(null,(function (){
var s__4937__$1 = s__4937;
while(true){
var temp__5804__auto__ = cljs.core.seq.call(null,s__4937__$1);
if(temp__5804__auto__){
var s__4937__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__4937__$2)){
var c__4527__auto__ = cljs.core.chunk_first.call(null,s__4937__$2);
var size__4528__auto__ = cljs.core.count.call(null,c__4527__auto__);
var b__4939 = cljs.core.chunk_buffer.call(null,size__4528__auto__);
if((function (){var i__4938 = (0);
while(true){
if((i__4938 < size__4528__auto__)){
var opt = cljs.core._nth.call(null,c__4527__auto__,i__4938);
cljs.core.chunk_append.call(null,b__4939,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),ttt.components.check.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"radio","radio",1323726374),new cljs.core.Keyword(null,"value","value",305978217),opt,new cljs.core.Keyword(null,"name","name",1843675177),id,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__4938,opt,c__4527__auto__,size__4528__auto__,b__4939,s__4937__$2,temp__5804__auto__){
return (function (p1__4935_SHARP_){
return ttt.components.update_state_BANG_.call(null,p1__4935_SHARP_,id,opt);
});})(i__4938,opt,c__4527__auto__,size__4528__auto__,b__4939,s__4937__$2,temp__5804__auto__))
], null),opt)], null),cljs.core.name.call(null,opt)], null));

var G__4940 = (i__4938 + (1));
i__4938 = G__4940;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__4939),ttt$components$radio_menu_$_iter__4936.call(null,cljs.core.chunk_rest.call(null,s__4937__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__4939),null);
}
} else {
var opt = cljs.core.first.call(null,s__4937__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),ttt.components.check.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"radio","radio",1323726374),new cljs.core.Keyword(null,"value","value",305978217),opt,new cljs.core.Keyword(null,"name","name",1843675177),id,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (opt,s__4937__$2,temp__5804__auto__){
return (function (p1__4935_SHARP_){
return ttt.components.update_state_BANG_.call(null,p1__4935_SHARP_,id,opt);
});})(opt,s__4937__$2,temp__5804__auto__))
], null),opt)], null),cljs.core.name.call(null,opt)], null),ttt$components$radio_menu_$_iter__4936.call(null,cljs.core.rest.call(null,s__4937__$2)));
}
} else {
return null;
}
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),(function (){var iter__4529__auto__ = (function ttt$components$board_row_$_iter__4941(s__4942){
return (new cljs.core.LazySeq(null,(function (){
var s__4942__$1 = s__4942;
while(true){
var temp__5804__auto__ = cljs.core.seq.call(null,s__4942__$1);
if(temp__5804__auto__){
var s__4942__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__4942__$2)){
var c__4527__auto__ = cljs.core.chunk_first.call(null,s__4942__$2);
var size__4528__auto__ = cljs.core.count.call(null,c__4527__auto__);
var b__4944 = cljs.core.chunk_buffer.call(null,size__4528__auto__);
if((function (){var i__4943 = (0);
while(true){
if((i__4943 < size__4528__auto__)){
var cell = cljs.core._nth.call(null,c__4527__auto__,i__4943);
cljs.core.chunk_append.call(null,b__4944,ttt.components.board_cell.call(null,cell));

var G__4945 = (i__4943 + (1));
i__4943 = G__4945;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__4944),ttt$components$board_row_$_iter__4941.call(null,cljs.core.chunk_rest.call(null,s__4942__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__4944),null);
}
} else {
var cell = cljs.core.first.call(null,s__4942__$2);
return cljs.core.cons.call(null,ttt.components.board_cell.call(null,cell),ttt$components$board_row_$_iter__4941.call(null,cljs.core.rest.call(null,s__4942__$2)));
}
} else {
return null;
}
...
return (new cljs.core.LazySeq(null,(function (){
var s__4947__$1 = s__4947;
while(true){
var temp__5804__auto__ = cljs.core.seq.call(null,s__4947__$1);
if(temp__5804__auto__){
var s__4947__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__4947__$2)){
var c__4527__auto__ = cljs.core.chunk_first.call(null,s__4947__$2);
var size__4528__auto__ = cljs.core.count.call(null,c__4527__auto__);
var b__4949 = cljs.core.chunk_buffer.call(null,size__4528__auto__);
if((function (){var i__4948 = (0);
while(true){
if((i__4948 < size__4528__auto__)){
var row = cljs.core._nth.call(null,c__4527__auto__,i__4948);
cljs.core.chunk_append.call(null,b__4949,ttt.components.board_row.call(null,row));

var G__4950 = (i__4948 + (1));
i__4948 = G__4950;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__4949),ttt$components$game_board_$_iter__4946.call(null,cljs.core.chunk_rest.call(null,s__4947__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__4949),null);
}
} else {
var row = cljs.core.first.call(null,s__4947__$2);
return cljs.core.cons.call(null,ttt.components.board_row.call(null,row),ttt$components$game_board_$_iter__4946.call(null,cljs.core.rest.call(null,s__4947__$2)));
}
} else {
return null;
}
