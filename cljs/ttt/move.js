...
var x = cljs.core.count.call(null,cljs.core.filter.call(null,(function (p1__4726_SHARP_){
return cljs.core._EQ_.call(null,"X",p1__4726_SHARP_);
}),board));
var y = cljs.core.count.call(null,cljs.core.filter.call(null,(function (p1__4727_SHARP_){
return cljs.core._EQ_.call(null,"O",p1__4727_SHARP_);
}),board));
...
return cljs.core.map.call(null,cljs.core.first,cljs.core.filter.call(null,(function (p1__4728_SHARP_){
return cljs.core._EQ_.call(null,cljs.core.second.call(null,p1__4728_SHARP_),null);
...
var cols = cljs.core.map.call(null,(function (p1__4729_SHARP_){
return cljs.core.take_nth.call(null,length,p1__4729_SHARP_);
...
return cljs.core.some.call(null,(function (p1__4733_SHARP_){
return (!(cljs.core.every_QMARK_.call(null,cljs.core.nil_QMARK_,p1__4733_SHARP_)));
}),cljs.core.map.call(null,(function (p1__4732_SHARP_){
return cljs.core.flatten.call(null,p1__4732_SHARP_);
}),cljs.core.filter.call(null,(function (p1__4731_SHARP_){
return cljs.core._EQ_.call(null,(1),cljs.core.count.call(null,p1__4731_SHARP_));
}),cljs.core.map.call(null,(function (p1__4730_SHARP_){
return cljs.core.partition_by.call(null,cljs.core.identity,p1__4730_SHARP_);
...
return cljs.core.map.call(null,(function (p1__4734_SHARP_){
return ttt.move.move.call(null,p1__4734_SHARP_,ttt.move.cur_token.call(null,board),board);
...
return cljs.core.apply.call(null,cljs.core.min,cljs.core.map.call(null,(function (p1__4735_SHARP_){
return ttt.move.minimax.call(null,p1__4735_SHARP_,(depth - (1)),false);
}),ttt.move.possible_moves.call(null,board)));
} else {
return cljs.core.apply.call(null,cljs.core.max,cljs.core.map.call(null,(function (p1__4736_SHARP_){
return ttt.move.minimax.call(null,p1__4736_SHARP_,(depth - (1)),true);
}),ttt.move.possible_moves.call(null,board)));
...
return cljs.core.apply.call(null,cljs.core.max_key,(function (p1__4737_SHARP_){
return ttt.move.minimax.call(null,p1__4737_SHARP_,ttt.move.get_depth.call(null,board),true);
}),ttt.move.possible_moves.call(null,board));
}));
cljs.core._add_method.call(null,ttt.move.next_move,new cljs.core.Keyword(null,"easy","easy",315769928),(function (_,board){
return cljs.core.apply.call(null,cljs.core.min_key,(function (p1__4738_SHARP_){
return ttt.move.minimax.call(null,p1__4738_SHARP_,ttt.move.get_depth.call(null,board),true);
}),ttt.move.possible_moves.call(null,board));
}));
cljs.core._add_method.call(null,ttt.move.next_move,new cljs.core.Keyword(null,"med","med",-1154404524),(function (_,board){
return cljs.core.apply.call(null,cljs.core.max_key,(function (p1__4739_SHARP_){
return ttt.move.minimax.call(null,p1__4739_SHARP_,(2),true);
}),ttt.move.possible_moves.call(null,board));
}));
